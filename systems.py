        ...
        if self.check == True:
            ...
            for i in range(1, 21):
                ...
                if i == 3:
                    ...
                    for i in self.interference_level.keys():
                        if self.interference_level[i] != 0:
                            print("(", i, "ch: ", self.interference_level[i], "Mbps", ")", sep='', end=' ')
                if i == 4:
                    print("Node info", end='')
                line_num = 5
                for ch in self.channel_list.keys():
                ...
                if i == 10:
                    if self.in_simul == True:
                        print("Current Error:", self.user.error(), end= '')
                if i == 11:
                    if self.in_simul == True:
                        print("Average Error:", self.user.whole_error(), end='')
                print()
            ...
            if "add node" in ipt:
                ...
                if self.grid_map.get(cor) == None:
                    ...
                    if self.grid_map[cor] == 0:
                        self.grid_map[cor] = nodeset.node(cor)
                        self.check = True
                        self.node_num += 1
        except:
            input()
                ...
                if self.grid_map.get(cor) == None:
                    ...
                    if self.grid_map[cor] != 0:
                        if int(channel_num) >= 11 or int(channel_num) <= 26:
                            self.grid_map[cor].set_channel(int(channel_num))
                            self.check = True
                        else:
